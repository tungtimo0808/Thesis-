...
Vision-Language Models take an image and a text instruction as input. Then they return a text answer. LLaVA is a clear example of this general idea, because it connects a vision encoder with a large language model and uses visual instruction tuning \cite{liu2023visual}. LLaVA itself is a general-domain model, not a dental one; it is cited here to explain what a VLM is. The same instruction-following idea has been applied in medicine, for report generation and visual question answering \cite{hartsock2024vlmreview}. For dental panoramic images, however, this use of VLMs is still new, and that gap is what this thesis works on.
