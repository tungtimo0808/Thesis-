...
\midrule
\multirow{2}{*}{InternVL3-8B}  & zero-shot base & 93.3 & 0.020 & 0.000 & 0.000 & 0.000 & 0.087 \\
                               & fine-tuned     & 100  & \textbf{0.830} & \textbf{0.607} & \textbf{0.189} & \textbf{0.519} & \textbf{0.696} \\
\midrule
\multirow{2}{*}{Qwen2.5-VL-7B} & zero-shot base & 100  & 0.077 & 0.000 & 0.000 & 0.000 & 0.100 \\
                               & fine-tuned     & 100  & \textbf{0.811} & \textbf{0.537} & \textbf{0.152} & \textbf{0.452} & \textbf{0.654} \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Indicative detector comparison.} The Faster R-CNN baseline uses a different split and an IoU-based match, so that comparison is indicative, not a controlled head-to-head.
...
\begin{itemize}
    \item \textbf{Detector--VLM hybrid.} The Faster R-CNN baseline is much stronger at recognition. A natural next step is to let a detector find the teeth and their conditions, and let the VLM turn that output into the report text. This keeps the recognition accuracy of a detector and the readable output of a VLM.
