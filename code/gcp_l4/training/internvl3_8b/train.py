...
This is the exact QLoRA fine-tuning configuration used to train InternVL3-8B for the
...
InternVL3-8B was the best model on the test set. It pairs the InternViT-300M vision
encoder with a Qwen2.5 language model.

What the script does, step by step:
  1. Load InternVL3-8B from Hugging Face.
...
How to run:
    cd ~/pan924
    python gcp_l4/training/internvl3_8b/train.py
