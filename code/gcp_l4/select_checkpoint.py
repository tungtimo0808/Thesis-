...
already logged during training, so NO generation runs here). Writes the choice to
<output_dir>/best_checkpoint.txt, which evaluate.py reads.

Usage:
  python select_checkpoint.py qwen
"""
import json
import os
import sys
